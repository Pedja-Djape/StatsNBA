          ...
          <div className="card-deck">
            <div className="card box-shadow-hover pointer">
              ...
              <div className="card-body">
                <p className="card-title">How efficient is your favourite player?</p>
                <h4 className="card-text" >Get individual and league-relative shot charts for over 200+ active players!</h4>
            ...
            <div className="card box-shadow-hover pointer">
              ...
              <div className="card-body">
                <p className="card-title">Who's more efficient?</p>
                <h4 className="card-text">Choose two of the top scorers in the league and compare their efficiency!</h4>
